...
function reloadFrame(frame, attaching) {
  const parentDoc = frame._ownerDocument;
  ...
  contentWindow.url = url.scheme === "javascript" || serializedURL === "about:blank" ? parentDoc.URL : serializedURL;
  contentDoc._URL = url;
  contentDoc.origin = url.origin;
