...
function navigateFetch(window, newURL) {
  if (window.frameElement) {
    // For frame/iframe, just navigate to the newURL by changing the src
    // It is not a proper handling of navigation but it will trigger the fetching of newURL
    const urlString = whatwgURL.serializeURL(newURL);
    window.frameElement.src = urlString;
  } else {
    // TODO:
